...
\begin{itemize}
  ...
  \item Co je digitální transformace a jak se projevuje?
  \item Jaká je role AI v bezpečnosti IS?
  \item Co je podniková architektura a jaké jsou její standardy?
  \item Jaké jsou typy diagramů při modelování IS?
  \item Co je objektový diagram a jak se liší od diagramu tříd?
  \item Co znamená systematická analýza IS?
  \item Jaké jsou typy modelování IS?
  \item Jaké jsou dimenze IS?
  \item Jaký je rozdíl mezi datovým a procesním modelem?
  \item Jaká je role sociálních sítí v IS?
\end{itemize}
...
\begin{itemize}
  \item Jak se využívá UML pro modelování IS?
  \item Co je konceptuální modelování a jaký je jeho cíl?
\end{itemize}
\textbf{Vencovský Filip, Ing., Ph.D.}
\begin{itemize}
  \item Co je EPC notace a jak se od ní liší jiné notace?
  \item Jaká data jsou potřebná pro modelování procesů?
\end{itemize}
\textbf{Sigmund Tomáš, doc. Ing., Ph.D.}
\begin{itemize}
  \item Jaké jazyky se používají pro modelování podnikových procesů?
\end{itemize}
\textbf{Komise: Pour, Sudzina, Zeman}
\begin{itemize}
  \item Jak se modeluje IS?
  \item Jaké metodiky analýzy a návrhu IS znáte?
  \item Co je CRM a jak se implementuje?
  \item Co je Elasticsearch a k čemu slouží?
  \item Jak se zajišťuje kvalita při vývoji IS?
\end{itemize}
\textbf{Komise: Řepa, Smutný, Strossa}
\begin{itemize}
  \item Popište architekturu TCP/IP.
  \item Jaký je rozdíl mezi TCP a UDP?
  \item Jak probíhá inovace IS?
\end{itemize}
\textbf{Komise: Zamazal, Doležel, Smutný}
\begin{itemize}
  \item Jak se zapisují požadavky na IS?
  \item Co je granularita user stories?
  \item Jak se modelují procesy?
  \item Jak se metrifikuje IS?
\end{itemize}
\end{profesorbox}
