...
IMRaD je formát \textbf{vědeckého článku} (journal paper), zatímco diplomová práce (DP) má rozsáhlejší strukturu odpovídající akademickým požadavkům školy.
...
\begin{itemize}
  \item \textbf{Abstrakt} -- stručné shrnutí obsahu práce (150--250 slov); součást vědeckého článku
  \item \textbf{Resumé} -- delší shrnutí (celá kapitola nebo část práce); někdy v jiném jazyce
  \item \textbf{Recenze} -- kritické hodnocení díla (knihy, článku, filmu); obsahuje analýzu a hodnocení
  \item \textbf{Rešerše} -- systematický přehled existující literatury k danému tématu
  \item \textbf{Konspekt} -- stručné zachycení hlavních myšlenek textu; pracovní poznámky
  \item \textbf{Teze} -- stručné formulace hlavních argumentů; osnova práce
  \item \textbf{Esej} -- volnější forma; osobní pohled na téma; argumentativní struktura
  \item \textbf{Polemika} -- odborná diskuse nebo kritická odpověď na jiný text
  \item \textbf{Referát} -- přehled informací k tématu určený k prezentaci
  \item \textbf{Monografie} -- rozsáhlá odborná práce věnovaná jednomu tématu (kniha)
  \item \textbf{Diplomová / disertační práce} -- rozsáhlé akademické práce s vlastním výzkumem
\end{itemize}
