...
\end{itemize}
\textbf{Basl Josef, prof. Ing., CSc.}
\begin{itemize}
  \item Jaká jsou kritéria optimalizace v podnikových IS?
  \item Jaké jsou přínosy podnikových IS?
  \item Jaké jsou hlavní aplikace v podnikových IS?
\end{itemize}
\textbf{Bruckner Tomáš, doc. Ing., Ph.D.}
\begin{itemize}
  \item Jaké modely, diagramy a audity se používají při implementaci ERP?
  \item Co dělat, pokud ERP systém neodpovídá podnikovým procesům?
  \item Co dělá ERP -- jaké jsou jeho klíčové funkce?
  \item Jak souvisí ERP a microservices architektura?
  \item Co je Low Code/No Code a jak se uplatňuje?
  \item Jaké jsou trendy v oblasti ERP?
  \item Co je orchestrace microservices?
\end{itemize}
\textbf{Potančok Martin, Ing., Ph.D.}
\begin{itemize}
  \item Popište prostředí podnikových IS.
  \item Jaké jsou aktuální trendy v oblasti podnikových IS?
\end{itemize}
\textbf{Komise: Zbořil, Dudáš, Basl}
\begin{itemize}
  \item Jaké jsou přínosy podnikových IS?
  \item Jaká jsou bezpečnostní rizika webových aplikací?
  \item Jaké protokoly se používají v podnikových IS?
\end{itemize}
\end{profesorbox}
