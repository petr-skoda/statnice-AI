...
\textbf{Sedláček Jiří, Ing., Ph.D.}
\begin{itemize}
  \item Jak se šifrují zprávy a jaké techniky se používají?
  \item Co je správa licencí SW?
  \item Jak chránit citlivá data v aplikaci?
  \item Jaké jsou třídy výpočetní složitosti?
  \item Jaká jsou cloudová řešení a jak se liší?
  \item Jaké jsou regulace v Evropě v oblasti bezpečnosti IS?
  \item Co je kybernetická bezpečnost?
  \item Jaké jsou techniky útoků na hesla?
  \item Jak správně chránit hesla?
  \item Co jsou halucinace AI a proč jsou bezpečnostním rizikem?
  \item Jaké jsou principy klient-server architektury?
  \item Jaké nástroje se používají na straně klienta a serveru?
  \item Co jsou HSTS a CSP a k čemu slouží?
  \item Jak probíhá SQL injection a jak mu předcházet?
\end{itemize}
\textbf{Rožmberská Lucie, Ing.}
\begin{itemize}
  \item Jaké bezpečnostní normy se uplatňují v bankovnictví?
  \item Jak probíhá bezpečnostní audit?
  \item Jaké jsou klíčové aspekty informační bezpečnosti?
\end{itemize}
\textbf{Pavlíček Antonín, doc. Ing., Ph.D.}
\begin{itemize}
  \item Co je hashovací funkce a k čemu slouží?
  \item Jaké jsou vlastnosti kryptografické hashovací funkce?
\end{itemize}
\textbf{Sklenák Vilém, prof. Ing., CSc.}
\begin{itemize}
  \item Jaké metody šifrování znáte?
  \item Jaký je rozdíl mezi symetrickou a asymetrickou kryptografií?
\end{itemize}
\textbf{Strnad Pavel, Ing., Ph.D.}
\begin{itemize}
  \item Jaké typy dat z hlediska bezpečnosti znáte?
  \item Jak zajistit bezpečnost při registraci uživatele?
  \item Jaké typy útoků na IS znáte?
\end{itemize}
\textbf{Maryška Miloš, doc. Ing., Ph.D.}
\begin{itemize}
  \item Jak zabezpečit chytrou domácnost (IoT)?
\end{itemize}
\textbf{Zbořil Martin, Ing., Ph.D.}
\begin{itemize}
  \item Jak chránit data v IS?
  \item Jaká jsou bezpečnostní rizika webových aplikací?
\end{itemize}
\textbf{Zimmermann Pavel, Ing., Ph.D.}
\begin{itemize}
  \item Jaké jsou zásady bezpečného vývoje SW?
\end{itemize}
\textbf{Komise: Svatá, Máša, Šedivá}
\begin{itemize}
  \item Jaká jsou rizika úniku dat?
  \item Co je informační bezpečnost a jak se zajišťuje?
\end{itemize}
\textbf{Komise: Buchalcevová, Pavlíček, Vadinský}
\begin{itemize}
  \item Jaká jsou bezpečnostní rizika velké platformy (např.\ YouTube)?
\end{itemize}
\textbf{Komise: Sklenák, Vojíř, Palovský}
\begin{itemize}
  \item Jaké programovací jazyky se používají na straně serveru?
  \item Jaké technologie se používají na straně klienta?
\end{itemize}
\end{profesorbox}
