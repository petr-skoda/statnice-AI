...
\end{itemize}
\textbf{Dudáš Marek, Ing., Ph.D.}
\begin{itemize}
  \item Popište síťové protokoly a vrstvy -- co se děje na které vrstvě?
  \item Jak vypadá záhlaví (hlavička) IP paketu?
  \item Jak probíhá autentizace a co jsou certifikáty?
\end{itemize}
\textbf{Smutný Zdeněk, Ing., Ph.D.}
\begin{itemize}
  \item Popište model TCP/IP a jeho vrstvy.
  \item Jak vypadá IP hlavička a jaká pole obsahuje?
  \item Jaký je rozdíl mezi TCP a UDP?
\end{itemize}
\textbf{Švarc Lukáš, Ing.}
\begin{itemize}
  \item Jaké API protokoly znáte?
  \item Jaký je rozdíl mezi HTTP a HTTPS?
  \item Co je certifikát a k čemu slouží?
  \item Jak funguje DNS?
\end{itemize}
\textbf{Zamazal Ondřej, Ing., Ph.D.}
\begin{itemize}
  \item Popište síťovou komunikaci, která proběhne, než se zobrazí webová aplikace v prohlížeči.
\end{itemize}
\textbf{Vojíř Stanislav, Ing., Ph.D.}
\begin{itemize}
  \item Jaké aplikační protokoly znáte a k čemu slouží?
  \item Co je digitální podpis a jak funguje?
  \item Co je VPN a jaké jsou jeho typy?
  \item Jaký je rozdíl mezi mobilní (responzivní) webovou a nativní aplikací?
\end{itemize}
\textbf{Sudzina František, Mgr.\ et Mgr.\ Ing., Ph.D.}
\begin{itemize}
  \item Popište síťovou vrstvu -- co zajišťuje a jaké protokoly na ní běží?
  \item Jak SSH zabezpečuje vzdálený přístup?
\end{itemize}
\textbf{Komise: Maryška, Vojíř, Sigmund}
\begin{itemize}
  \item Jak funguje HTTP a HTTPS? Jaký je mezi nimi rozdíl?
  \item Jaké jsou verze HTTP a v čem se liší?
  \item Jaký je rozdíl mezi UDP a HTTP z hlediska spolehlivosti přenosu?
\end{itemize}
\end{profesorbox}
