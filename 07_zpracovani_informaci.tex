...
\end{itemize}
\textbf{Kliegr Tomáš, Ing., Ph.D.}
\begin{itemize}
  \item Jaké jsou metody shlukování a jak fungují?
  \item Co jsou asociační pravidla a jak se měří jejich kvalita (podpora, spolehlivost)?
  \item Jaký je rozdíl mezi TF-IDF a IDF?
  \item Jak se evaluují modely strojového učení?
  \item Co jsou náhodné lesy a jak fungují?
  \item Jaké vzdálenostní funkce se používají v ML?
  \item Co je rozhodovací strom a jak se buduje?
  \item Jak se zapisuje a přenáší JSON?
  \item Jak se využívá UML pro komunikaci v SW projektu?
\end{itemize}
\textbf{Vadinský Ondřej, Ing., Ph.D.}
\begin{itemize}
  \item Jak funguje klasifikace v ML?
  \item Jaký je rozdíl mezi rozhodovacím stromem a neuronovou sítí?
  \item Co je dobývání znalostí?
  \item Jaké typy modelů lze použít pro klasifikaci?
  \item Jaký je rozdíl mezi shlukováním a klasifikací?
  \item Co je explorativní analýza dat?
  \item Jak použít SL pro analýzu dotazníkového šetření?
\end{itemize}
\textbf{Strnad Pavel, Ing., Ph.D.}
\begin{itemize}
  \item Co je overfitting a underfitting a jak jim předcházet?
  \item Jaké typy strojového učení znáte?
  \item Jaký je základní rozdíl mezi SL s učitelem a bez učitele?
  \item Jak se provádí anonymizace dat?
  \item Má LLM vědomí? Jak odpovědět na tuto otázku?
\end{itemize}
\textbf{Dudáš Marek, Ing., Ph.D.}
\begin{itemize}
  \item Jaké parametry vzorku jsou důležité pro trénování modelu SL?
  \item Jakou techniku SL použít pro klasifikaci?
\end{itemize}
\textbf{Buchalcevová Alena, doc. Ing., Ph.D.}
\begin{itemize}
  \item Jak se CRISP-DM liší od metodik vývoje SW?
\end{itemize}
\textbf{Zamazal Ondřej, Ing., Ph.D.}
\begin{itemize}
  \item Jaké typy úloh strojového učení znáte?
\end{itemize}
...
\begin{itemize}
  \item Jaké metody strojového učení znáte?
  \item Jak může SL podpořit konkrétní aplikaci?
\end{itemize}
\textbf{Rožmberská Lucie, Ing.}
\begin{itemize}
  \item Jaký je rozdíl mezi AI a strojovým učením?
  \item Jak lze integrovat AI do ERP systému?
\end{itemize}
\textbf{Komise: Zamazal, Doležel, Smutný}
\begin{itemize}
  \item Jak se testují modely strojového učení?
\end{itemize}
\textbf{Komise: Zamazal, Zbořil, Zimmermann}
\begin{itemize}
  \item Jaké úlohy strojového učení znáte?
  \item Jaká je role kvality dat při trénování modelů?
\end{itemize}
\textbf{Komise: Řepa, Chudán, Sudzina}
\begin{itemize}
  \item Jaké kategorie strojového učení znáte?
  \item Co jsou asociační pravidla a k čemu se využívají?
  \item Co je analýza sentimentu?
\end{itemize}
\end{profesorbox}
